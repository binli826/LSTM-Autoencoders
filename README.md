...
## Usage
#### Data preparation
Once datasets avaliable, covert the raw data into uniform format using [dataPreparation]（https://github.com/binli826/LSTM-Autoencoders/blob/master/src/dataPreparation.py)
