...
%	\eIf{len(updatingBuffer) == updateDataSize}{update(updatingBuffer)\;}
	 \eIf{len(normalBuffer) >= SN $\textbf{and}$ len(abnormalBuffer) >= SA}{update(normalBuffer, abnormalBuffer)\;}
	{
